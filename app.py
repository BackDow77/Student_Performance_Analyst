...
if add_selectbox == "Dashboard":
    ...
    st.write(
        """
        Oleh: Dwi Hadi Yulvi Baskoro / @hadhibaskoro
        """
    )
    ...
    with col1:
        ...
        try:
            ...
            colors = ["#970606" if b != maxA else 'black' for b in a.index]
            bars = go.Bar(x=a.index, y=a, marker=dict(color=colors, line=dict(color='black', width=1)), text=a, textposition='auto')

            layout = {
                'xaxis': {'title': 'Status', 'tickfont': {'color': 'black'}, 'color': 'black', 'showline': True, 'linecolor': 'black', 'linewidth': 1},
                'yaxis': {'title': 'Number of Student', 'tickfont': {'color': 'black'}, 'color': 'black', 'showline': True, 'linecolor': 'black', 'linewidth': 1},
                'plot_bgcolor': "#9A0404",
                'paper_bgcolor': "#860505",
                'font': {'color': 'black'},
    ...
    with col2:
        ...
        try:
            ...
            bars_1st_sem = go.Bar(
                ...
                y=avg_1st_sem, 
                name='1st Semester',
                marker=dict(color="#A10606", line=dict(color='black', width=1)),
        ...
        with col1:
            ...
            try:
                ...
                fig = px.bar(
                    ...
                    color_discrete_sequence=["#9B0707" if b != maxA else 'black' for b in a_sorted.index],
                    height=600
                )
